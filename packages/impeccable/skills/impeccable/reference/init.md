...
- **Iterate visually**: use pi's native web tools (`web_screenshot`, `web_visit`, `web_interact`, `web_console`) to inspect and drive the rendered page; run the `impeccable_detect` tool on saved HTML for a deterministic pass.
