...
import { e as dt, p as pt, u as ut$1, a as Fe, D as De, l as lt, f as ft, F, c as ce } from './context-DYtVF_Lv.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
  ...
  const n = createMemo(on(t.routerState.matches, (e, s, u) => {
    ...
    for (let l = 0, w = e.length; l < w; l++) {
      ...
      u && b && g.route.key === b.route.key ? m[l] = u[l] : (f = false, r[l] && r[l](), createRoot((R) => {
        r[l] = R, m[l] = ft(t.routerState, m[l - 1] || t.routerState.base, k(() => n()[l + 1]), () => {
          var _a;
...
function Pt() {
  return createComponent(ht, { root: (t) => createComponent(dt, { get children() {
...
//# sourceMappingURL=app-DuxaipsU.mjs.map
